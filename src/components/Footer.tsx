      ...
      <footer className="bg-white py-4 dark:bg-black">
        <div className="max-w-screen-xl mx-auto p-4 md:flex md:items-center md:justify-between">
          ...
          <div className="flex items-center mt-3 sm:mt-0">
            {/* GitHub */}
            <a 
              href="https://github.com/rahul161616" /* PUT YOUR GITHUB URL HERE */
              className="text-gray-500 hover:text-gray-900 dark:hover:text-white p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300"
            ...
            {/* Instagram */}
            <a 
              href="https://www.instagram.com/rahulsewa07/
" /* PUT YOUR INSTAGRAM URL HERE */
              className="text-gray-500 hover:text-pink-600 dark:hover:text-pink-400 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 ml-2"
            ...
            {/* Twitter */}
            <a 
              href="https://x.com/rahul_sewa16" /* PUT YOUR TWITTER URL HERE */
              className="text-gray-500 hover:text-blue-400 dark:hover:text-blue-400 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 ml-2"
